/** Fund the Fete — Toy Drive interactive sponsor registry */
...
const EGLNY_THEME_KEY = "toydrive-theme";
const LEGACY_THEME_KEY = "maf2026-theme";

/** elkgrovetoydrive.com embed — site nav owns theme UI + toydrive-theme storage */
...
function renderProgress() {
  ...
  // Same for earned cash above MVP.
...
async function init() {
  ...
  try {
    ...
    document.querySelector(".page").innerHTML = `
      ...
      <code>cd "Sites/elkgrovetoydrive" && python3 -m http.server 8766</code><br>
      Then open http://localhost:8766/fund-the-fete/<br><br>${err.message}</p>`;
  }
}
